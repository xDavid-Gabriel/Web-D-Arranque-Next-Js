  ...
  return (
    <>
      ...
      <main>
          ...
          <div className="bg-primary mt-[250px]  pt-[140px] pb-[40px] relative z-[-1] xl:mt-[410px] xl:pt-[250px]">
            <div className="!max-w-[310px] w-full top-0 z-10 translate-y-[-60%] left-1/2 -translate-x-1/2 absolute xl:!max-w-[518px]">
              ...
              <p className="hidden xl:block max-w-[332px] absolute top-[80px] left-[-345px]">
                ¡Esta es tu oportunidad de GANAR una KTM! participa en nuestra
                rifa y forma parte de esta iniciativa que busca ayudar a un
                motero en apuros, juntos démosle la mano a un motero.
              </p>
            </div>
            <div className="container flex flex-col gap-[10px] xl:flex-row">
              ...
              <div className="flex flex-col gap-[7px] max-w-[275px] text-center mx-auto relative">
                ...
                <p>
                  Barras invertidas WP APEX de 43 mm y monoshock WP APEX
                  regulable con recorrido de 150 mm
                </p>
              </div>
              ...
              <div className="flex flex-col gap-[7px] max-w-[275px] text-center mx-auto  relative">
                ...
                <p>
                  ...
                  ABS, posterior disco de 230 mm con cáliper BYBRE monopistón
                  con ABS desconectable.
                </p>
              </div>
            </div>
        ...
        <section
          className="container mt-[30px] lg:mt-[120px]"
          id="paso-a-seguir"
        >
          <TypographyH2 className="text-center">
            <span className="inline-block rotate-[180deg]">?</span>COMO
            PARTICIPAR EN ESTE GRAN SORTEO?
          </TypographyH2>
            ...
            <div className="flex items-center gap-[20px] text-center lg:max-w-[463px]">
              ...
              <div className="bg-white/10 p-[17px_11px] rounded-[8px] shadow-[0px_5px_50px_0px_rgba(90,90,90,0.20)] flex flex-col gap-[11px] items-center">
                <p>
                  ...
                  porque es realizado de forma manual y con cuidado para
        ...
        >
          <div className="text-center container text-white flex flex-col gap-[30px] items-center">
            ...
            <div className="max-w-[857px]">
              ...
              <p className="mt-[10px]">
                DEMOSTREMOS que en esta COMUNIDAD REALMENTE HAY UNIÓN y
                HERMANDAD.
              </p>
            </div>
        ...
        >
          <div className="flex flex-col gap-[20px] lg:gap-[26px]">
            ...
            />
            <p>
              Mi nombre es Sergio Salazar Palomino, soy motero desde hace 6 años
              y hago contenido sobre motos desde hace 4 años y medio
              ...
              mano a un motero que lo necesite y tal vez más adelante poder
              ayudar a muchos más. Muchas gracias por ser parte de esto, estoy
              seguro que juntos podemos generar una bola de nieve de ayuda
              motera. ¡Nos vemos en las pistas!
            </p>
          </div>
          <img
            src="/img/sobre-mi.png"
